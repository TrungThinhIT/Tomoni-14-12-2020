    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="{{route('auth.doLogin')}}" method="POST" id="formLogin">
                    @csrf
                    ...
                    <div class="form-group">
                        <input class="form-control" value="{{ Request::old('uname') }}"  type="text" name="uname" placeholder="Username">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="link login-link text-center">
                        Do you forgot password? <a
                            href="{{route('auth.passwordResetIndex')}}">Reset Password</a></div>
                </form>
            </div>
        </div>
    </div>
