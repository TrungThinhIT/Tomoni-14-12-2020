        ...
        <div class="sidebar-content">
            <ul class="nav nav-info" class="">
                ...
                <li class="nav-item dropdown" style="color:#44a5f1">
                    <a class="nav-link dropdown-toggle" href="../components/alerts.php" id="navbarDropdownMenuLink"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="../components/componentWarehouse.php"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link " href="{{route('anhmv')}}" id="navbarDropdownMenuLink" aria-expanded="false">
