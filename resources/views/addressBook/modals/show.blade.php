...
<div class="modal-body">
    <div class="col-12">
        <div class="form-row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input class="form-control" value="{{$product->weight}}" type="number" id="weight" min="0"
    ...
    <script>
        ...
        //                 const totalNewWeightKhoi = ((response.width * response.height * response.length) /
        //                     1000000) * quantity;
        ...
        //                     /(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + ' khối');
        //                 if (response.weight > 0 && response.width > 0 && response.height > 0 && response
        //                     .length > 0) {
